...
all: ${RELEASE_FILE_MYSPELL} ${RELEASE_FILE_ASPELL}
...
${RELEASE_FILE_MYSPELL}: myspell/el_GR.dic myspell/*
	...
	@zip -j ${RELEASE_FILE_MYSPELL} tmp/el_GR.aff tmp/el_GR.dic myspell/README_el_GR.txt
	@rm -f tmp/*
	@echo "Created version ${VERSION} of el_GR myspell support at ${RELEASE_FILE_MYSPELL}"
